      ...
      <div className="review-card">
        <div className="review-card-header">
          <div className="header-left">
            ...
            >
              {/* --- UPDATED: Icon --- */}
              <i className={isCard1Open ? 'la la-chevron-circle-down' : 'la la-chevron-circle-right'} />
            </button>
        ...
        {isCard1Open && (
          <div className="review-card-content">
            ...
            <div className="review-grid">
              <ReviewField label="Employment Type" value={careerData.employmentType} />
              <ReviewField label="Work Arrangement" value={careerData.workSetup} />
            ...
            <div className="review-grid">
              ...
              <ReviewField label="State/Province" value={getFullProvinceName()} />
            ...
            {/* --- UPDATED: Changed $ to ₱ --- */}
            <div className="review-grid">
              <ReviewField label="Minimum Salary" value={careerData.minimumSalary ? `₱${careerData.minimumSalary}` : 'N/A'} />
              <ReviewField label="Maximum Salary" value={careerData.maximumSalary ? `₱${careerData.maximumSalary}` : 'N/A'} />
            ...
            <div className="review-field">
              ...
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: careerData.description || '<p>No description provided.</p>',
                }}
              />
            </div>
          </div>
      ...
      <div className="review-card">
        <div className="review-card-header">
          <div className="header-left">
            ...
            >
              {/* --- UPDATED: Icon --- */}
              <i className={isCard2Open ? 'la la-chevron-circle-down' : 'la la-chevron-circle-right'} />
            </button>
        ...
        {isCard2Open && (
          <div className="review-card-content">
            <div className="review-grid full-width">
              <ReviewField label="CV Screening" value={careerData.screeningSetting} />
            </div>
            <hr className="review-divider" />
            <div className="review-field">
              <label>CV Secret Prompt</label>
              <p className="review-text" style={{ fontStyle: 'italic', color: '#555' }}>
                {careerData.workSetupRemarks || 'No custom instructions provided.'}
              </p>
            </div>
            <hr className="review-divider" />
            <div className="review-field">
              ...
              {careerData.questions[0]?.questions.length > 0 ? (
                <ol style={{ paddingLeft: '20px', margin: 0, width: '100%' }}>
                  {careerData.questions[0].questions.map((q: any) => (
                    <li key={q.id} className="review-text" style={{ marginBottom: '8px' }}>
                      {q.title}
                    </li>
                  ))}
                </ol>
      ...
      <div className="review-card">
        <div className="review-card-header">
          <div className="header-left">
            ...
            >
              {/* --- UPDATED: Icon --- */}
              <i className={isCard3Open ? 'la la-chevron-circle-down' : 'la la-chevron-circle-right'} />
            </button>
        ...
        {isCard3Open && (
          <div className="review-card-content">
            <div className="review-grid">
              <ReviewField label="AI Interview Screening" value={careerData.screeningSetting} />
              <ReviewField label="Require Video on Interview" value={careerData.requireVideo ? 'Yes' : 'No'} />
            </div>
            <hr className="review-divider" />
            <div className="review-field">
